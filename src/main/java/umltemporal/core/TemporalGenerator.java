...
public class TemporalGenerator {
	...
	/**
	 * Get the child with 'negative' guard - aka the branch which is False
	 * (has NOT in the beggining)
	 *
	 * @return
	 */
	 ...
	 *
	 * @param node UmlNode representing on of: ACTIVITY_FINAL_NODE,
	 * JOIN_NODE, MERGE_NODE
	 * @param stack
	 * @return null if is ACTIVITY_FINAL_NODE, first node from false subexpression for loops, next node otherwise
	 */
